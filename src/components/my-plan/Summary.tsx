...
const SummaryItem = ({
	...
	return (
		<div className="not-last:border-r border-gray-800 w-full px-8 first:text-foreground">
...
const Summary = () => {
	...
	return (
		<div className="flex items-center justify-between bg-gray-800/30 py-7 rounded-xl border border-gray-800">
